...
public class MySQLDB extends SQLDB {
    ...
    private void loadDataSource() {
        ...
        checkDatabaseVersionCompatibility();
    }

    private void checkDatabaseVersionCompatibility() {
        String serverVersion = query(MySQLSchemaQueries.getVersion())
                .orElseThrow(() -> new DBInitException("Could not determine MySQL/MariaDB server version."));
